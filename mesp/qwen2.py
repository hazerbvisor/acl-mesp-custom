...
from mlx_lm.models.qwen2 import ModelArgs, Attention, MLP, TransformerBlock, Qwen2Model
...
def export_loss(
    ...
    assert "x" in variable_names and "targets" in variable_names and isinstance(module, Qwen2Model)
