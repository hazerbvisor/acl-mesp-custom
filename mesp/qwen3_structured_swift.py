...
#
"""
LoRA-Structured Export for Swift Backward.
...
1. Forward outputs include intermediate values for backward
2. No backward function is exported - Swift handles backward
3. Swift uses structured LoRA backward primitives
"""
...
def export_transformer_block_for_swift_backward(
    ...
    """
    Export transformer block for Swift-side structured backward.
    ...
    def forward_with_intermediates(*inputs):
        ...
        # Note: We're saving more than strictly necessary for a full implementation
        # The key is that we're NOT saving h = x @ A for each LoRA linear
        return (
            y.astype(dtype),
